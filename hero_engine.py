...
HEROES: dict[str, dict] = {
    ...
    "Rose Princess":{"tier": "Mythic", "faction": "Liga",     "has_uw": True,  "has_hs": False, "skills": 5, "trait3": "Critical Resistance +30%"},
    "Beastmaster":  {"tier": "Mythic", "faction": "Horda",    "has_uw": True,  "has_hs": True,  "skills": 5, "trait3": "Skill Damage Reduction +50%"},
    "Desert Prince":{"tier": "Mythic", "faction": "Horda",    "has_uw": True,  "has_hs": False, "skills": 5, "trait3": "Skill Damage Reduction +50%"},
    ...
    "Altar Marshal":{"tier": "Mythic", "faction": "Natureza", "has_uw": True,  "has_hs": False, "skills": 5, "trait3": "HP Drain +20%"},
